         ...
         <div class="content">
                ...
                <div class="content__body">
                        ...
                        <div class="content__body__wrapper">
                            <div class="container__sidebar">
                                <div class="container__input input__search">
                                    <input id="search" class="input input__icon" type="text"
                              ...
                              <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-center" style="min-width:100px;">NGÀY SINH</th>
                    ...
                    <div class="content__footer">
                        <div class="content__footer_letf">
                            Tổng số <b>999</b> bản ghi
                        </div>
